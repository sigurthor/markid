# RailsAdmin config file. Generated on July 19, 2012 15:26
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Markid', 'Umsjonarkerfi']
 ...
 # config.compact_show_view = true
  ...
  config.model NumberOfGears do
    label 'Gears'
    object_label_method :gears
    parent Bike
  end

  config.model BikeType do
    label 'Category'
    parent Bike
  end
